...
with open('/Users/rishi/Desktop/Personal-projects/tradingAnalyzer/backend/app.yaml') as file:
...
def stock_screener(stock_symbols):
    filtered_stocks = []
    output_file = '/Users/rishi/Desktop/Personal-projects/tradingAnalyzer/backend/filtered_stocks.csv'  # Specify the output file path
...
schedule.every().day.at("12:15", "America/New_York").do(check_all_stocks,'filtered_stocks.csv')
# schedule.every(2).hours.do(check_all_stocks,'filtered_stocks.csv')
#Every morning run the filtered stocks through algorithm
check_all_stocks('/Users/rishi/Desktop/Personal-projects/tradingAnalyzer/backend/filtered_stocks.csv')
while True:
